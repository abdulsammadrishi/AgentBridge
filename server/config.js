...
module.exports = { port, publicBaseUrl, apiBaseUrl, dataDir, corsOrigins, webmcpOriginTrialToken: process.env.WEBMCP_ORIGIN_TRIAL_TOKEN || '', demoResetEnabled: process.env.DEMO_RESET_ENABLED !== 'false' };
