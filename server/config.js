...
module.exports = { port, host, publicBaseUrl, apiBaseUrl, dataDir, corsOrigins, webmcpOriginTrialToken: process.env.WEBMCP_ORIGIN_TRIAL_TOKEN || '', demoResetEnabled: process.env.DEMO_RESET_ENABLED !== 'false', autoSeedDemo: process.env.AUTO_SEED_DEMO === 'true' };
